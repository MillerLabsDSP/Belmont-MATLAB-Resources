...
% Calculate amplitude of each harmonic bin

a = (2/N) * Xc(101,1); % normalize amplitude
b = (2/N) * Xs(101,1); % normalize amplitude

Amp1 = sqrt(a^2 + b^2); % amp of 100 Hz - fundamental
...
% Calculate THD
THD = sqrt((Amp2^2 + Amp3^2 + Amp4^2 + Amp5^2 + Amp6^2)/Amp1^2);
THDlinear = 20 * log10(THD); % linear dB reading
THD = THD * 100; % convert to percentage
disp(THD);
...
numbers = zeros(1,5); i = 1;                                                    % Initialize "i" variable for loo[
...
sumPositive = 0; sumNegative = 0; sumZero = 0; posCounter = 0; negCounter = 0;  % Initializing new variables for sorting loop

...
adjustC1poltheta = deg2rad(C1poltheta + 30);
adjustC2poltheta = deg2rad(C2poltheta + 210);
adjustC3poltheta = deg2rad(C3poltheta + 210);
adjustC4poltheta = deg2rad(C4poltheta + 30);
